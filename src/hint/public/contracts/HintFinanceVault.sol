...
contract HintFinanceVault is Test {
    ...
    function flashloan(address token, uint256 amount, bytes calldata data) external updateReward(address(0)) {
        ...
        // @ctf this is evaluated as false so will put zeros in the memory
        ...
        // @ctf amount = length
        // @ctf isUnderlyingOrReward = offset
        // @ctf data = _sandVault + bytes32(0)
